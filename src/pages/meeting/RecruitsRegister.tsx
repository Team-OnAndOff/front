    ...
    <div className='flex flex-col'>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='mx-auto mt-6 border-b-2 pb-1.5 border-b-light-gray-color'>
          <h3 className='mt-1 text-size-title'>Crew/Challenge 참여하기</h3>
        </div>
        <div className='mt-6'>
        ...
        <div className='mt-6'>
          <div className='flex items-center'>
            ...
            <h3 className='mt-1 ml-1 text-size-title'>경력을 적어주세요!</h3>
          </div>
          <div className='mt-3'>
            <TextArea
        ...
        <div className='flex gap-3 justify-center mt-6 p-2.5'>
          <Button type='submit' fill='activeFill' onClick={handleBtnClick}>
            신청하기
          </Button>
