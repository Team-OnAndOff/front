...
export default function Footer() {
  return (
    <footer className='bottom-0 w-full pt-8 pb-4 pl-20 pr-20 text-center border-t border-dark-gray-color'>
      <ul className='flex flex-col pb-4 text-sm text-left border-b gap-y-1 border-light-gray-color'>
        <li>
          <img className='w-[100px]' src={Logo} alt='온앤오프 기업 대표 로고' />
        </li>
        <li className='mt-6'>
      ...
      <small className='text-dark-gray-color text-[0.6rem] text-left'>
        온앤오프는 모임 중개기관으로 온앤오프 플랫폼을 통하여 방장과 모임 참여자
        사이에 이루어지는 모임의 당사자가 아닙니다. 온앤오프 플랫폼을 통하여
        예약된 일정, 장소, 방장 서비스에 관한 의무와 책임은 해당 서비스를
        제공하는 방장에게 있습니다.
      </small>
    </footer>
  )
