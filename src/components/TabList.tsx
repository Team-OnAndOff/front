...
const Tab = ({ id, label, onClick, isSelected }: TabProps) => {
  const tabStyles = `flex-1 items-center px-1 py-4 text-sm border-b-2 gap-x-2 whitespace-nowrap focus:outline-none ${
    isSelected
      ? 'font-semibold border-main-color dark:border-sub-color text-main-color dark:text-sub-color smooth-color'
      : 'hover:text-gray-500 hover:dark:text-white border-transparent text-dark-gray-color smooth-color'
  }`
  return (
...
export default function TabList({
  ...
  return (
    <div className='border-b border-light-gray-color dark:border-sub-hover-color smooth-color'>
      <nav
